<template>
  <div v-if="obj">
    ...
    <div v-show="!isLoading" style="overflow-y:visible" ref="body">
      <div class="chat-header custom-header">
        <span>
          To:
          <span class="name">{{
...
export default {
  ...
  methods: {
    redirect: function(userid, to) {
      ...
      window.open("http://mobile.cnc.com/mobile/app/user/chats.php", "_blank");
